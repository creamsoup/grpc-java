...
/**
 * A throttler that keeps track of recent history (the duration of which is specified to the
 * constructor) and throttles requests at the client side based on the number of requests that the
