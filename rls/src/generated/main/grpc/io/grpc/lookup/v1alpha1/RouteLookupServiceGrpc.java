package io.grpc.lookup.v1alpha1;
...
public final class RouteLookupServiceGrpc {
  ...
  public static final String SERVICE_NAME = "google.lookup.v1alpha1.RouteLookupService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<io.grpc.lookup.v1alpha1.RouteLookupRequest,
      io.grpc.lookup.v1alpha1.RouteLookupResponse> getRouteLookupMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RouteLookup",
      requestType = io.grpc.lookup.v1alpha1.RouteLookupRequest.class,
      responseType = io.grpc.lookup.v1alpha1.RouteLookupResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.grpc.lookup.v1alpha1.RouteLookupRequest,
      io.grpc.lookup.v1alpha1.RouteLookupResponse> getRouteLookupMethod() {
    io.grpc.MethodDescriptor<io.grpc.lookup.v1alpha1.RouteLookupRequest, io.grpc.lookup.v1alpha1.RouteLookupResponse> getRouteLookupMethod;
      ...
      synchronized (RouteLookupServiceGrpc.class) {
        if ((getRouteLookupMethod = RouteLookupServiceGrpc.getRouteLookupMethod) == null) {
          RouteLookupServiceGrpc.getRouteLookupMethod = getRouteLookupMethod =
              io.grpc.MethodDescriptor.<io.grpc.lookup.v1alpha1.RouteLookupRequest, io.grpc.lookup.v1alpha1.RouteLookupResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RouteLookup"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.lookup.v1alpha1.RouteLookupRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.lookup.v1alpha1.RouteLookupResponse.getDefaultInstance()))
  ...
  public static abstract class RouteLookupServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void routeLookup(io.grpc.lookup.v1alpha1.RouteLookupRequest request,
        io.grpc.stub.StreamObserver<io.grpc.lookup.v1alpha1.RouteLookupResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.grpc.lookup.v1alpha1.RouteLookupRequest,
                io.grpc.lookup.v1alpha1.RouteLookupResponse>(
  ...
  public static final class RouteLookupServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<RouteLookupServiceBlockingStub> {
     ...
     * </pre>
     */
    public io.grpc.lookup.v1alpha1.RouteLookupResponse routeLookup(io.grpc.lookup.v1alpha1.RouteLookupRequest request) {
  ...
  public static final class RouteLookupServiceFutureStub extends io.grpc.stub.AbstractFutureStub<RouteLookupServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.lookup.v1alpha1.RouteLookupResponse> routeLookup(
        io.grpc.lookup.v1alpha1.RouteLookupRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ROUTE_LOOKUP:
          serviceImpl.routeLookup((io.grpc.lookup.v1alpha1.RouteLookupRequest) request,
              (io.grpc.stub.StreamObserver<io.grpc.lookup.v1alpha1.RouteLookupResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class RouteLookupServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.grpc.lookup.v1alpha1.RouteLookupServiceProto.getDescriptor();
    }
