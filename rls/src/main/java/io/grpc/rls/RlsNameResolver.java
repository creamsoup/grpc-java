...
/**
 * A {@link NameResolver} for resolving gRPC target names with "rls-experimental" scheme.
 *
 ...
 *
 * @see RlsNameResolverProvider
 */
final class RlsNameResolver extends NameResolver {

  private final String authority;

  RlsNameResolver(String name) {
