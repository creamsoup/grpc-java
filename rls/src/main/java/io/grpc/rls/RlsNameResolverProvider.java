...
/**
 * A provider for {@link RlsNameResolver}.
 *
 * <p>It resolves a target URI whose scheme is {@code "rls-experimental"}. The authority of the
 ...
 * scheme "rls-experimental".
 */
public final class RlsNameResolverProvider extends NameResolverProvider {

  private static final String SCHEME = "rls-experimental";

  @Override
  public RlsNameResolver newNameResolver(URI targetUri, Args args) {
    if (SCHEME.equals(targetUri.getScheme())) {
      ...
      return new RlsNameResolver(name);
    }
    return null;
  }
